...
public class StoreController {
    ...
    @AllowedUsers(userTypes = {UserType.OWNER, UserType.ADMIN, UserType.STORE_MANAGER})
    @RequiredPartner
    @PostMapping("/search")
    ...
    public ResponseModel<StoreModel> update(@PathVariable UUID id, @Valid @RequestBody UpdateStoreDto dto) throws ParseException {
        Store store = storeService.updateStore(id, dto);
