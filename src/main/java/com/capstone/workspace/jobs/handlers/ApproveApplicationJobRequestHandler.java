...
import com.capstone.workspace.services.application.application_approval.ApproveAddStoreApplication;
...
public class ApproveApplicationJobRequestHandler implements JobRequestHandler<ApproveApplicationJobRequest> {
    ...
    private BaseApproveApplication getHandler(Application application) {
        switch (application.getType()) {
            ...
            case ADD_STORE:
                return BeanHelper.getBean(ApproveAddStoreApplication.class);
            default:
                return null;
        }
    }
